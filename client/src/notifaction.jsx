...
<section id='navbar'>
        <div className="nav1">
          ...
          <div className="icons nav1-icons"> <span className='icon' class="material-symbols-outlined"  onClick={handleclickN} style={{borderBottom:bor}}>
...
<div className="notifaction">No notifaction found.</div>
